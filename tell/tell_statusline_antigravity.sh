...
#
# The bar in resources/extras/statusline-antigravity.sh packs six kinds of
...
echo "branch, a session under a cent drops the costs, and an idle session with no"
echo "subagents drops [agents]."
echo ""
